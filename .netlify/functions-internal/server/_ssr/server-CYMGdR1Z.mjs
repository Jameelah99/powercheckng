...
import { a as X_TSS_RAW_RESPONSE, d as safeObjectMerge, i as TSS_SERVER_FUNCTION, l as flattenMiddlewares, n as TSS_CONTENT_TYPE_FRAMED_VERSIONED, o as X_TSS_SERIALIZED, r as TSS_FORMDATA_CONTEXT, s as createNullProtoObject, t as FrameType, u as getStartOptions } from "./createServerFn-C4XsUSXf.mjs";
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-BtjTQTdJ.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-B2p06KoR.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-puFRtGd-.mjs"),
		import("./start-2nZD1_Nv.mjs"),
